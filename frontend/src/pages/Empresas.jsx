    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-200">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-black text-gray-800 dark:text-gray-100">Empresas</h1>
            ...
            {empresas.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {empresas.map(empresa => (
                        <div key={empresa.id} className="bg-white dark:bg-gray-900 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 transition-colors">
                            <div className="flex items-start justify-between gap-3">
                                {/* Info empresa */}
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                    <div className="bg-brand/10 dark:bg-brand/20 p-2.5 rounded-xl shrink-0">
                                        <Building2 size={20} className="text-brand" />
                                    </div>
                                    <div className="min-w-0">
                                        <p className="font-bold text-gray-900 dark:text-gray-100 truncate">{empresa.nombre}</p>
                                ...
                                <div className="flex gap-1 shrink-0">
                                    <button
                                        ...
                                        className="p-2 rounded-xl bg-amber-50 dark:bg-amber-950/40 text-amber-500 dark:text-amber-400 active:scale-95 transition-all"
                                        title="Ver notas"
                                    >
                                        <FileText size={16} />
                                    </button>
                                    <button
                                        ...
                                        className="p-2 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-brand active:scale-95 transition-all"
                                        title="Editar"
                                    >
                                        <Pencil size={16} />
                                    </button>
                                    <button
                                        ...
                                        className="p-2 rounded-xl bg-red-50 dark:bg-red-950/40 text-red-500 dark:text-red-400 active:scale-95 transition-all"
                                        title="Eliminar"
                                    >
                                        <Trash2 size={16} />
                                    </button>
